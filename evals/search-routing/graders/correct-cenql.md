...
target: trace
criteria: |
  The agent must construct a CenQL query that finds SSH hosts on
...
focus: Is the CenQL query correct for finding SSH on non-standard ports?
---

The constructed CenQL query must scope both SSH protocol and non-standard
